...
TRAIN_BASE_PATH = "data/pir_ir/index"
cfg.DATASET.TRAINVAL_DATA_SOURCE = "RGB_IR"
cfg.DATASET.TRAIN_DATA_ROOT = "data/pir_ir/train"
...
TEST_BASE_PATH = "data/pir_ir/index"
cfg.DATASET.TEST_DATA_SOURCE = "RGB_IR"
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "data/pir_ir/eval"
